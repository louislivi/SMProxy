...
interface Capabilities
{
    ...
    const CLIENT_CAPABILITIES = (
        ...
        self::CLIENT_IGNORE_SPACE | self::CLIENT_PROTOCOL_41 | self::CLIENT_TRANSACTIONS | self::CLIENT_INTERACTIVE |
        self::CLIENT_SECURE_CONNECTION | self::CLIENT_MULTI_RESULTS | self::CLIENT_PLUGIN_AUTH |
        self::CLIENT_PLUGIN_AUTH_LENENC_CLIENT_DATA | self::CLIENT_CONNECT_ATTRS
    );
    # Not done yet
